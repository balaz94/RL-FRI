...
def learning():
    ...
    agent = AgentA2C(0.99, actions, Net(), 0.001, beta_entropy = 0.001, id=0, name="sc2_find_and_defeat_zerglings")
    # agent.load_model()
...
def animate():
    ...
    agent = AgentA2C(0.99, actions, Net(), id=0, name="sc2_find_and_defeat_zerglings")
    agent.load_model()
